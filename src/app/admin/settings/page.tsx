...
const permissionCopy: Record<Permission, string> = {
  ...
  PAYMENTS_VIEW: "View payment status and payment records.",
  PAYMENTS_REQUEST: "Prepare standard payment requests.",
  PAYMENTS_APPROVE: "Approve server-priced standard payment requests.",
  PAYMENTS_REFUND: "Approve and manage refunds.",
  PAYMENTS_MANAGE: "Manage payment-provider configuration.",
